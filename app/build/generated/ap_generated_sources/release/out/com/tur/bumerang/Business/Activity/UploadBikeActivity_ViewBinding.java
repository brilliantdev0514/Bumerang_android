...
public class UploadBikeActivity_ViewBinding implements Unbinder {
  private UploadBikeActivity target;
  ...
  @UiThread
  public UploadBikeActivity_ViewBinding(UploadBikeActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UploadBikeActivity_ViewBinding(final UploadBikeActivity target, View source) {
    this.target = target;

    View view;
    target.lyt_categoty_camera = Utils.findRequiredViewAsType(source, R.id.lyt_categoty_camera, "field 'lyt_categoty_camera'", LinearLayout.class);
    target.edt_upload_cameratitle = Utils.findRequiredViewAsType(source, R.id.edt_upload_cameratitle, "field 'edt_upload_cameratitle'", EditText.class);
    target.edt_camera_des = Utils.findRequiredViewAsType(source, R.id.edt_camera_des, "field 'edt_camera_des'", EditText.class);
  ...
  @CallSuper
  public void unbind() {
    UploadBikeActivity target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.lyt_categoty_camera = null;
    target.edt_upload_cameratitle = null;
    target.edt_camera_des = null;
