...
public class UploadMusicActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public UploadMusicActivity_ViewBinding(UploadMusicActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UploadMusicActivity_ViewBinding(final UploadMusicActivity target, View source) {
    this.target = target;

    View view;
    target.lyt_categoty_music = Utils.findRequiredViewAsType(source, R.id.lyt_categoty_music, "field 'lyt_categoty_music'", LinearLayout.class);
    target.edt_music_title = Utils.findRequiredViewAsType(source, R.id.edt_music_title, "field 'edt_music_title'", EditText.class);
    target.edt_music_des = Utils.findRequiredViewAsType(source, R.id.edt_music_des, "field 'edt_music_des'", EditText.class);
  ...
  @CallSuper
  public void unbind() {
    UploadMusicActivity target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.lyt_categoty_music = null;
    target.edt_music_title = null;
    target.edt_music_des = null;
