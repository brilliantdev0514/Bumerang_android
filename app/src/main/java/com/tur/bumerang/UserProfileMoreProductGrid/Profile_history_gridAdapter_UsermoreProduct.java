...
public class Profile_history_gridAdapter_UsermoreProduct extends BaseAdapter {

    private UserProfileMoreProductAll activity;
    private ArrayList<ItemModel> sonses = new ArrayList<>();



    public Profile_history_gridAdapter_UsermoreProduct(UserProfileMoreProductAll context, ArrayList<ItemModel> orders) {
        super();
