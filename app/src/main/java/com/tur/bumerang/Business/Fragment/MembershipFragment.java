package com.tur.bumerang.Business.Fragment;
...
//        txv_back.setOnClickListener(this);
        ...
        if(page==0) {
            img_membertype.setImageResource(R.mipmap.membership_start);
        }
        else if(page==1) {
            img_membertype.setImageResource(R.mipmap.membership_plus);
        }
        else if(page==2){
            img_membertype.setImageResource(R.mipmap.membership_prime);
        }
