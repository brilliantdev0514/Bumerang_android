...
public class DetailbikeActivity extends BaseActivity  implements OnMapReadyCallback {

    @BindView(R.id.detail_bike_title)  TextView detail_bike_title;
    @BindView(R.id.detail_bike_price) TextView detail_bike_price;
    @BindView(R.id.detail_bike_des)
    EditText detail_bike_des;
    ...
    @BindView(R.id.txv_address) TextView txv_address;

    GoogleMap mGoogleMap;
    @BindView(R.id.mapView) CustomMapView mapView;
    @BindView(R.id.deletePro) ImageView deletePro;
    @BindView(R.id.btn_rent_bike) Button editandmessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailbike);

        ButterKnife.bind(this);

        detail_bike_title.setText(Constants.itemModel.title);
        ...
        txv_address.setText(Constants.itemModel.address);
        detail_bike_price.setText(String.valueOf(Constants.itemModel.price) + "₺" + "\n" + Constants.itemModel.date_unit);
        detail_bike_des.setText(Constants.itemModel.description);
        Glide
                .with(this)
        ...
        if(owner_id.equals(Constants.itemModel.owner_id)){
            ...
            detail_bike_des.setClickable(false);
            detail_bike_des.setFocusable(false);
            detail_bike_des.setFocusableInTouchMode(false);
            editandmessage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (editandmessage.getText().toString().equals("Düzenle")) {
                        detail_bike_des.setFocusable(true);
                        detail_bike_des.setFocusableInTouchMode(true);
                        detail_bike_des.setClickable(true);
                        detail_bike_des.requestFocus();
                        ...
                        des.setValue(detail_bike_des.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(DetailbikeActivity.this, "Başarıyı kaydedin!", Toast.LENGTH_SHORT).show();
                                detail_bike_des.setFocusable(false);
                                detail_bike_des.setFocusableInTouchMode(false);
                                detail_bike_des.setClickable(false);
                                editandmessage.setText("Düzenle");
            ...
            editandmessage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Constants.itemModel.rental_state != null && Constants.itemModel.rental_state.equals("Yes")) {
                        ...
                        if (EasyPreference.with(DetailbikeActivity.this).getInt("easyRegistStatus", 0) == 1) {
                            Intent intent = new Intent(DetailbikeActivity.this, ChattingActivity.class);
        ...
        deletePro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Constants.itemModel.owner_id != FirebaseAuth.getInstance().getCurrentUser().getUid()) {
                    ...
                    new AlertDialog.Builder(DetailbikeActivity.this)
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    deleting.child(String.valueOf(Constants.itemModel.id)).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Intent intent = new Intent(DetailbikeActivity.this, HomeActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }
                                    });
...
//                startActivity(intent);
                if(userInfo.length() == 0) {
                    Intent intent = new Intent(DetailbikeActivity.this, UserProfileActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity(intent);
                }else {
                    Intent intent =  new Intent(DetailbikeActivity.this, UserProfileBusinessActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity( intent);
                }
            }
...
//        if(Constants.itemModel.rental_state != null && Constants.itemModel.rental_state.equals("Yes")){
//            btn_rent_bike.setText(R.string.alread_rent);
//            btn_rent_bike.setClickable(false);
//        }else{
//            btn_rent_bike.setClickable(true);
//            btn_rent_bike.setText(R.string.rent);
//        }
