...
public class Constants {
   ...
   */
  public static final String CURRENCY_CODE = "TL";
   ...
   */
  public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList("TR", "GB");
      ...
      new HashMap<String, String>() {
        {
          ...
          put("gatewayMerchantId", "04630602333204745597");
