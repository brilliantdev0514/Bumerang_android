...
public class DetailcaravanActivity extends BaseActivity implements OnMapReadyCallback {

    String userInfo;
    @BindView(R.id.detail_caravan_title) TextView detail_caravan_title;
    @BindView(R.id.detail_caravan_fuel) TextView detail_caravan_fuel;
    @BindView(R.id.detail_caravan_bed) TextView detail_caravan_bed;
    @BindView(R.id.detail_caravan_deposit) TextView detail_caravan_deposit;
    @BindView(R.id.detail_caravan_price) TextView detail_caravan_price;
    @BindView(R.id.detail_caravan_des) TextView detail_caravan_des;
    @BindView(R.id.detail_owner_avatar) ImageView detail_caravan_avatar;
    @BindView(R.id.detail_owner_name) TextView detail_caravan_ownername;
    @BindView(R.id.detail_owner_products) Button detail_owner_products;
    @BindView(R.id.btn_rent_caravan) Button editandmessage;
    //@BindView(R.id.detail_caravan_address) TextView detail_caravan_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailcaravan);
        ButterKnife.bind(this);
        detail_caravan_title.setText(Constants.itemModel.title);
        //detail_caravan_address.setText(Constants.itemModel.address);
        ...
        getFragmentManager()
                ...
                .commit();
        detail_caravan_deposit.setText(Constants.itemModel.deposit);
        detail_caravan_fuel.setText(Constants.itemModel.fuel_type);
        detail_caravan_bed.setText(String.valueOf(Constants.itemModel.bed_capacity));
        detail_caravan_price.setText(String.valueOf(Constants.itemModel.price) + "₺" + "\n" + Constants.itemModel.date_unit);
        detail_caravan_des.setText(Constants.itemModel.description);
        Glide
                .with(this)
                .load(Constants.itemModel.owner_info.avatarUrl)
                .centerCrop()
                .placeholder(R.mipmap.ic_avatar)
                .into(detail_caravan_avatar);
        detail_caravan_ownername.setText(Constants.itemModel.owner_info.firstName + " " + Constants.itemModel.owner_info.lastName);

//        detail_caravan_ownername.setText(Constants.itemModel.owner_info.firstName);
//        detail_caravan_score.setText(Constants.itemModel.owner_info.score);
        ...
        if(owner_id.equals(Constants.itemModel.owner_id)){
            ...
            detail_caravan_des.setClickable(false);
            detail_caravan_des.setFocusable(false);
            detail_caravan_des.setFocusableInTouchMode(false);
            editandmessage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (editandmessage.getText().toString().equals("Düzenle")) {
                        detail_caravan_des.setFocusable(true);
                        detail_caravan_des.setFocusableInTouchMode(true);
                        detail_caravan_des.setClickable(true);
                        detail_caravan_des.requestFocus();
                        ...
                        des.setValue(detail_caravan_des.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(DetailcaravanActivity.this, "Başarıyı kaydedin!", Toast.LENGTH_SHORT).show();
                                detail_caravan_des.setFocusable(false);
                                detail_caravan_des.setFocusableInTouchMode(false);
                                detail_caravan_des.setClickable(false);
                                editandmessage.setText("Düzenle");
            ...
            editandmessage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Constants.itemModel.rental_state != null && Constants.itemModel.rental_state.equals("Yes")) {
                        ...
                        if (EasyPreference.with(DetailcaravanActivity.this).getInt("easyRegistStatus", 0) == 1) {
                            Intent intent = new Intent(DetailcaravanActivity.this, ChattingActivity.class);
        ...
        deletePro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Constants.itemModel.owner_id != FirebaseAuth.getInstance().getCurrentUser().getUid()) {
                    ...
                    new AlertDialog.Builder(DetailcaravanActivity.this)
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    deleting.child(String.valueOf(Constants.itemModel.id)).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Intent intent = new Intent(DetailcaravanActivity.this, HomeActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }
                                    });
...
//                startActivity(intent);
                if(userInfo.length() == 0) {
                    Intent intent = new Intent(DetailcaravanActivity.this, UserProfileActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity(intent);
                }else {
                    Intent intent =  new Intent(DetailcaravanActivity.this, UserProfileBusinessActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity( intent);
                }
            }
...
//        String owner_id = EasyPreference.with(this).getString("easyUserId", "");
//        if(owner_id.equals(Constants.itemModel.owner_id)){
//            findViewById(R.id.btn_rent_caravan).setVisibility(View.GONE);
