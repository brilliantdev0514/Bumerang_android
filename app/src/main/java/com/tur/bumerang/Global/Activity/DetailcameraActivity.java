...
public class DetailcameraActivity extends BaseActivity implements OnMapReadyCallback {
    String userInfo;
   // @BindView(R.id.btn_rent_camera) Button btn_rent_camera;
    ...
    @BindView(R.id.detail_owner_name) TextView detail_ownername;
    @BindView(R.id.detail_owner_avatar) ImageView detail_avatar;
    @BindView(R.id.detail_owner_products) Button detail_owner_products;
    @BindView(R.id.btn_rent_camera) Button editandmessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailcamera);
        ...
        Glide
                ...
                .into(detail_avatar);
        detail_ownername.setText(Constants.itemModel.owner_info.firstName + " " + Constants.itemModel.owner_info.lastName);

//        detail_ownername.setText(Constants.itemModel.owner_info.firstName);
                    ...
                    if (editandmessage.getText().toString().equals("Düzenle")) {
                        ...
                        des.setValue(detail_des.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(DetailcameraActivity.this, "Başarıyı kaydedin!", Toast.LENGTH_SHORT).show();
            ...
            editandmessage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Constants.itemModel.rental_state != null && Constants.itemModel.rental_state.equals("Yes")) {
                        ...
                        if (EasyPreference.with(DetailcameraActivity.this).getInt("easyRegistStatus", 0) == 1) {
                            Intent intent = new Intent(DetailcameraActivity.this, ChattingActivity.class);
        ...
        deletePro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Constants.itemModel.owner_id != FirebaseAuth.getInstance().getCurrentUser().getUid()) {
                    ...
                    new AlertDialog.Builder(DetailcameraActivity.this)
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    deleting.child(String.valueOf(Constants.itemModel.id)).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Intent intent = new Intent(DetailcameraActivity.this, HomeActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }
                                    });
...
//                startActivity(intent);
                if(userInfo.length() == 0) {
                    Intent intent = new Intent(DetailcameraActivity.this, UserProfileActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity(intent);
                }else {
                    Intent intent =  new Intent(DetailcameraActivity.this, UserProfileBusinessActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity( intent);
                }
            }
...
//        String owner_id = EasyPreference.with(this).getString("easyUserId", "");
//        if(owner_id.equals(Constants.itemModel.owner_id)){
//            findViewById(R.id.btn_rent_camera).setVisibility(View.GONE);
