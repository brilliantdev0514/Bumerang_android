...
public class DetaildressActivity extends BaseActivity implements OnMapReadyCallback {

    String userInfo;
    @BindView(R.id.detail_dress_title) TextView detail_dress_title;
    //@BindView(R.id.detail_dress_gender) TextView detail_dress_gender;
    @BindView(R.id.detail_dress_size) TextView detail_dress_size;
    @BindView(R.id.detail_dress_color) TextView detail_dress_color;
    @BindView(R.id.detail_dress_price) TextView detail_dress_price;
    @BindView(R.id.detail_dress_deposit) TextView detail_dress_deposit;
    @BindView(R.id.detail_dress_des) TextView detail_dress_des;
    ...
    @BindView(R.id.detail_dress_address) TextView detail_dress_address;
    @BindView(R.id.btn_rent_dress) Button editandmessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detaildress);

        ButterKnife.bind(this);

        detail_dress_title.setText(Constants.itemModel.title);
        ...
        detail_dress_deposit.setText(Constants.itemModel.deposit);
        //detail_dress_gender.setText(Constants.itemModel.gender);
        detail_dress_size.setText(Constants.itemModel.size);
        detail_dress_price.setText(String.valueOf(Constants.itemModel.price) + "₺" + "\n" + Constants.itemModel.date_unit);
        detail_dress_color.setText(Constants.itemModel.color);
        detail_dress_des.setText(Constants.itemModel.description);
        detail_dress_address.setText(Constants.itemModel.address);
        Glide
                .with(this)
...
//        detail_dress_score.setText(Constants.itemModel.owner_info.score);
        //TODO;edit detail
        ...
        if(owner_id.equals(Constants.itemModel.owner_id)){
            ...
            detail_dress_des.setClickable(false);
            detail_dress_des.setFocusable(false);
            detail_dress_des.setFocusableInTouchMode(false);
            editandmessage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (editandmessage.getText().toString().equals("Düzenle")) {
                        detail_dress_des.setFocusable(true);
                        detail_dress_des.setFocusableInTouchMode(true);
                        detail_dress_des.setClickable(true);
                        detail_dress_des.requestFocus();
                        ...
                        des.setValue(detail_dress_des.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(DetaildressActivity.this, "Başarıyı kaydedin!", Toast.LENGTH_SHORT).show();
                                detail_dress_des.setFocusable(false);
                                detail_dress_des.setFocusableInTouchMode(false);
                                detail_dress_des.setClickable(false);
                                editandmessage.setText("Düzenle");
            ...
            editandmessage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Constants.itemModel.rental_state != null && Constants.itemModel.rental_state.equals("Yes")) {
                        ...
                        if (EasyPreference.with(DetaildressActivity.this).getInt("easyRegistStatus", 0) == 1) {
                            Intent intent = new Intent(DetaildressActivity.this, ChattingActivity.class);
        ...
        deletePro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Constants.itemModel.owner_id != FirebaseAuth.getInstance().getCurrentUser().getUid()) {
                    ...
                    new AlertDialog.Builder(DetaildressActivity.this)
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    deleting.child(String.valueOf(Constants.itemModel.id)).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Intent intent = new Intent(DetaildressActivity.this, HomeActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }
                                    });
...
//                startActivity(intent);
                if(userInfo.length() == 0) {
                    Intent intent = new Intent(DetaildressActivity.this, UserProfileActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity(intent);
                }else {
                    Intent intent =  new Intent(DetaildressActivity.this, UserProfileBusinessActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity( intent);
                }
            }
...
//        String owner_id = EasyPreference.with(this).getString("easyUserId", "");
//        if(owner_id.equals(Constants.itemModel.owner_id)){
//            findViewById(R.id.btn_rent_dress).setVisibility(View.GONE);
