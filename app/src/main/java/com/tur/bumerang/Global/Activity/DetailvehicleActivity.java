...
public class DetailvehicleActivity extends BaseActivity implements OnMapReadyCallback {

    String userInfo;
    @BindView(R.id.btn_rent_vehicle) Button editandmessage;
    @BindView(R.id.detail_vehicle_person)   TextView detail_vehicle_person;
    @BindView(R.id.detail_vehicle_title)   TextView detail_vehicle_title;
    @BindView(R.id.detail_vehicle_captan) TextView detail_vehicle_captan;
    @BindView(R.id.detail_vehicle_price) TextView detail_vehicle_price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailvehicle);

        ButterKnife.bind(this);

        detail_vehicle_title.setText(Constants.itemModel.title);
        ...
        detail_vehicle_captan.setText(Constants.itemModel.captan);
        detail_vehicle_person.setText(Constants.itemModel.person_capacity);
        detail_vehicle_price.setText(String.valueOf(Constants.itemModel.price) + "₺" + "\n" + Constants.itemModel.date_unit);
...
//        detail_vehicle_score.setText(Constants.itemModel.owner_info.score);
        //TODO;edit detail
                    ...
                    if (editandmessage.getText().toString().equals("Düzenle")) {
                        ...
                        des.setValue(detail_des.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(DetailvehicleActivity.this, "Başarıyı kaydedin!", Toast.LENGTH_SHORT).show();
                                detail_des.setFocusable(false);
                                detail_des.setFocusableInTouchMode(false);
                                detail_des.setClickable(false);
                                editandmessage.setText("Düzenle");
            ...
            editandmessage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Constants.itemModel.rental_state != null && Constants.itemModel.rental_state.equals("Yes")) {
                        ...
                        if (EasyPreference.with(DetailvehicleActivity.this).getInt("easyRegistStatus", 0) == 1) {
                            Intent intent = new Intent(DetailvehicleActivity.this, ChattingActivity.class);
        ...
        deletePro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Constants.itemModel.owner_id != FirebaseAuth.getInstance().getCurrentUser().getUid()) {
                    ...
                    new AlertDialog.Builder(DetailvehicleActivity.this)
...
//                startActivity(intent);
                if(userInfo.length() == 0) {
                    Intent intent = new Intent(DetailvehicleActivity.this, UserProfileActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity(intent);
                }else {
                    Intent intent =  new Intent(DetailvehicleActivity.this, UserProfileBusinessActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity( intent);
                }
            }
...
//        String owner_id = EasyPreference.with(this).getString("easyUserId", "");
//        if(owner_id.equals(Constants.itemModel.owner_id)){
//            findViewById(R.id.btn_rent_vehicle).setVisibility(View.GONE);
