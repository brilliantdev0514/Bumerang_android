...
public class DetailsporeActivity extends BaseActivity {

    String userInfo;
    @BindView(R.id.btn_rent_spore) Button editandmessage;
    @BindView(R.id.detail_title) TextView detail_title;
    @BindView(R.id.detail_other_address) TextView detail_other_address;

    @BindView(R.id.detail_price_other)  TextView detail_price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailspore);
        ...
        getFragmentManager()
                ...
                .commit();
        detail_other_address.setText(Constants.itemModel.address);
                    ...
                    if (editandmessage.getText().toString().equals("Düzenle")) {
                        ...
                        des.setValue(detail_des.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(DetailsporeActivity.this, "Başarıyı kaydedin!", Toast.LENGTH_SHORT).show();
                                detail_des.setFocusable(false);
                                detail_des.setFocusableInTouchMode(false);
                                detail_des.setClickable(false);
                                editandmessage.setText("Düzenle");
            ...
            editandmessage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Constants.itemModel.rental_state != null && Constants.itemModel.rental_state.equals("Yes")) {
                        ...
                        if (EasyPreference.with(DetailsporeActivity.this).getInt("easyRegistStatus", 0) == 1) {
                            Intent intent = new Intent(DetailsporeActivity.this, ChattingActivity.class);
        ...
        deletePro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Constants.itemModel.owner_id != FirebaseAuth.getInstance().getCurrentUser().getUid()) {
                    ...
                    new AlertDialog.Builder(DetailsporeActivity.this)
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    deleting.child(String.valueOf(Constants.itemModel.id)).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Intent intent = new Intent(DetailsporeActivity.this, HomeActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }
                                    });
...
//                startActivity(intent);
                if(userInfo.length() == 0) {
                    Intent intent = new Intent(DetailsporeActivity.this, UserProfileActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity(intent);
                }else {
                    Intent intent =  new Intent(DetailsporeActivity.this, UserProfileBusinessActivity.class);
                    intent.putExtra("owner_id", Constants.itemModel.owner_id);
                    startActivity( intent);
                }
            }
